...
namespace Etienne\BlogBundle\Tests\Controller;
...
class AdminControllerTest extends BlogTestCase
{
    ...
    public function testEditBlog()
    {
        $crawler = $this->client->request('GET',
                   $this->router->generate('EtienneBlogBundle_admin_blog_edit', array('id' => 1)), array(), array(), array());
    ...
    {
        $crawler = $this->client->request('GET',
                   $this->router->generate('EtienneBlogBundle_admin_blog_create'), array(), array(), array());
    ...
    {
        $crawler = $this->client->request('GET',
                 $this->router->generate('EtienneBlogBundle_admin'), array(), array(), array());
