...
namespace Etienne\BlogBundle\Tests\Twig\Extensions;

use Etienne\BlogBundle\Twig\Extensions\EtienneBlogBundleExtension;

class EtienneBlogBundleExtensionTest extends \PHPUnit_Framework_TestCase
{
    public function testCreatedAgo()
    {
        $blog = new EtienneBlogBundleExtension();
