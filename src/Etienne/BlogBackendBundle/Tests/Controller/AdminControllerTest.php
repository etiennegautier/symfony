...
use Etienne\BlogBackendBundle\Controller\AdminController;
...
class AdminControllerTest extends BlogTestCase {
    ...
    public function testCreateBlog() {
        ...
        $this->client->request('POST', $this->router->generate('EtienneBlogBackendBundle_create_blog'),
            array(), array(),
            array(),
            json_encode($data)
        );
    ...
    public function testCreateBlogWithMissingFields() {
        $this->client->request('POST', $this->router->generate('EtienneBlogBackendBundle_create_blog'), array(), array());
    ...
    public function testCreateBlogWithLongTitle() {
        ...
        $this->client->request('POST', $this->router->generate('EtienneBlogBackendBundle_create_blog'), array(), array(), array(), json_encode($data));
    ...
    public function testEditBlog() {
        ...
        $this->client->request('PUT', $this->router->generate('EtienneBlogBackendBundle_edit_blog', array('id' => 1)), array(), array(), array(), json_encode($data)
        );
    ...
    public function testDeleteBlog() {
        $this->client->request('DELETE', $this->router->generate('EtienneBlogBackendBundle_delete_blog'), array('blogs' => array(1)), array()
        );
